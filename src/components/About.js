...
const About = () => {
    ...
    <div className="container2">
            ...
            <div className="right">
                ...
                <h1 style={{fontSize:30}}>Transform the World!</h1>
                <p style={{fontSize:15}}>Lorem ipsum dolor sit amet consectetur. Aenean lectus convallis molestie cras nulla sed elit odio. Dignissim sit est proin turpis ipsum a odio accumsan. In faucibus tempor morbi at diam leo vulputate viverra. Vel sagittis faucibus ornare sit.</p>
        ...
        <div className="new-section">
            ...
            <div className="custom-div">
                <br></br>
            <p className="main-paragraph">Become one of us!</p>
            <h1 className="main-heading" style={{textAlign:'center'}}>Members Benefit</h1>
        ...
        <div className="white-background">
            ...
            <div className="rownew">
                <div className="columnnew">
                    <img src={backgroundImage} className="new-section-image" alt="Right About Image" /><br></br>
                    <h1>Few Words From Director’s Desk</h1>
        ...
        <div className="new-section">
                ...
                <button className="button" style={{ backgroundColor: ' #F54E4E', marginLeft: '0px' }}>Read More</button>
