...
const Home = () => {
    return (
        ...
        <section className="home" id="home">
           ...
           <div className="containerj fade-in " >
    ...
    <div className="row">
        <div className="column">
            <div className="icon-heading">
                <img src={iconImage1} className="icon icon-small" alt="Icon 1" />
        ...
        <div className="column">
            <div className="icon-heading">
                <img src={iconImage2} className="icon icon-small" alt="Icon 2" />
        ...
        <div className="column">
            <div className="icon-heading">
                <img src={iconImage3} className="icon icon-small" alt="Icon 3" />
        ...
        <div className="column">
            <div className="icon-heading">
                <img src={iconImage4} className="icon icon-small" alt="Icon 4" />
            ...
            <div className="new-section">
                ...
                <div className="centered-content">
                    <h2 style={{fontSize:25}}>Your Gateway to Lifelong Learning Starts Here</h2>
                 <br></br><br></br>
                </div>
